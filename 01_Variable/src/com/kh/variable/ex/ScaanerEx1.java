...
public class ScaanerEx1 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 기본으로 구성되어있는 것은 아님
		 import.java.util 표시를 해준 후 사용할 수 있음
		...
		int num1 = sc.nextInt(); // 다음에 입력된 정수를 가져와서 num1에 대입
		// 5. Scanner close 사용해서 닫아주기
		
		System.out.print("정수 2 입력 2 : ");
		int num2 = sc.nextInt(); // 다음에 입력된 정수를 가져와서 num2에 대입
		...
		// 앞에 자료형이나 변수명을 사용해서 버퍼를 넣어 저장해야 할 이유가 없다
		// sc.nextLine() 으로만 사용
